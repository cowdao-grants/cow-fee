...
const MAX_GAS_INCREASE = 200; // 200% of original gas price
const WAIT_TIME_FOR_MAX_GAS_PRICE = 60 * 60 * 1000; // 1 hour
const TIMEOUT_BEFORE_INCREASING_GAS_PRICE = 5 * 60 * 1000; // 5 min
